/*
 * UpdateDeleteBirthdayForm.java
 *
 * Created on October 7, 2011, 3:26 AM
 */
 ...
 * @author  karmanya
 */
public class UpdateDeleteBirthdayForm extends javax.swing.JFrame {

    /** Creates new form UpdateDeleteBirthdayForm */
    public UpdateDeleteBirthdayForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel9.setText("UPDATE/DELETE BIRTHDAY FORM");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTextField1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
...
try
{
  ...
  Statement stmt1=con1.createStatement();
    ...
    String str1="delete from birthday where name='"+(n)+"'";
...
try
{
 ...
 String name=jTextField2.getText();
    ...
    String str2="update birthday set name='"+(name)+"',d='"+(d)+"' ,m='"+(m)+"',y='"+(y)+"'where name='"+(n)+"'";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateDeleteBirthdayForm().setVisible(true);
            }
        });
    }
