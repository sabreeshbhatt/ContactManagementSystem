/*
 * BirthDayEntryForm.java
 *
 * Created on October 7, 2011, 2:25 AM
 */
 ...
 * @author  karmanya
 */
public class BirthDayEntryForm extends javax.swing.JFrame {

    /** Creates new form BirthDayEntryForm */
    public BirthDayEntryForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("BIRTHDAY ENTRY ENTRY FORM");
...
try
{
    ...
    String str="insert into birthday(id,name,day,month,year) values('"+(id)+"',+'"+(n)+"','"+(d)+"','"+(m)+"','"+(yr)+"')";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BirthDayEntryForm().setVisible(true);
            }
        });
    }
