 ...
 * PhoneEntryForm.java
 *
 * Created on October 4, 2011, 12:08 AM
 */
 ...
 * @author  karmanya
 */
public class PhoneEntryForm extends javax.swing.JFrame {

    /** Creates new form PhoneEntryForm */
    public PhoneEntryForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PHONE NO. ENTRY FORM");
...
try
{
	...
	int ph =Integer.parseInt(jTextField3.getText());
	
    String str="insert into phone(email,name,phno) values('"+(em)+"',+'"+(name )+"','"+(ph)+"')";
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhoneEntryForm().setVisible(true);
            }
        });
    }
